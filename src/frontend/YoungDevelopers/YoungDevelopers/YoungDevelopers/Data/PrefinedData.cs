...
{
    public static class PrefinedData
    {
        ...
        public static List<ReadDog> PredefinedDogs => new List<ReadDog>
        {
            new ReadDog { Id = 1, Name = "Бен", Breed = "Бернедудл", Weight = 30, BirthDate = new DateTime(1993, 1, 1) , UserId = 1},
            new ReadDog { Id = 2, Name = "Барбарик", Breed = "Английский бульдог", Weight = 12, BirthDate = new DateTime(2017, 12, 5), UserId = 2},
            new ReadDog { Id = 3, Name = "Арчи", Breed = "Овчарка", Weight = 20, BirthDate = new DateTime(2015, 7, 7) , UserId = 3},
        };
