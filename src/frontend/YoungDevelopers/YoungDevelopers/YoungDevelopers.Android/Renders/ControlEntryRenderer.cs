...
[assembly: ExportRenderer(typeof(ControlEntry), typeof(ControlEntryRenderer))]
namespace YoungDevelopers.Droid
{
    class ControlEntryRenderer : EntryRenderer
    {
        public ControlEntryRenderer(Context context) : base(context)
        { }
